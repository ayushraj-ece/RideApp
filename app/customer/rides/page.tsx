...
import { History, Calendar, MapPin, Navigation, Bike, Car, Package, Loader2, ArrowLeft, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-200 font-sans pb-20">
      ...
      <main className="flex-1 max-w-2xl w-full mx-auto p-4 sm:p-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Link
            href="/customer"
            className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white shadow-sm transition-transform active:scale-95"
          >

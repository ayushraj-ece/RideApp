      ...
      <main className="flex-1 max-w-2xl w-full mx-auto p-4 sm:p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">History of accepted and completed customer rides</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-3xl bg-slate-900 border border-slate-800 p-8 text-center text-slate-400">
            ...
            <p className="text-xs text-slate-500 mt-1">Go online to receive real-time ride requests!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-800/80 text-xs">
                  <span className="text-slate-400">
                    Customer: <strong className="text-slate-200">{ride.customer?.name || 'Rider'}</strong>
                  </span>
                  <span className="text-slate-400">
